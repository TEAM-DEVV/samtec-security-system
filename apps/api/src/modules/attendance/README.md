...
| `biometrics.controller.ts`, `biometrics.service.ts` | The consent text, and recording a worker's consent on a kiosk (the Ghana Card check, and one open question at a time). |
