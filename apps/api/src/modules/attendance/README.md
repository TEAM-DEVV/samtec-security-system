...
- **A review holds both records.** It is a question about two people, so an open review stops consent, enrollment, a new exemption request and a revoke for the worker whose face is under review **and** for the worker it looked like. The verdict lands whatever happened meanwhile: a record whose face a withdrawal or the sweep already wiped is blocked where it stands, keeping that wipe's own time and name, because a wipe is never undone or re-signed. Without that, an insider could wipe the look-alike's face and leave the honest verdict with nothing to block.
