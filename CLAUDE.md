...
- **Phase 4 (payroll) — Samuel owns it, end to end.** Not started. Every open design question is already decided in [docs/plan/09-payroll-engine-ghana.md](docs/plan/09-payroll-engine-ghana.md); the house style is in [docs/plan/16-building-a-backend-module.md](docs/plan/16-building-a-backend-module.md).
